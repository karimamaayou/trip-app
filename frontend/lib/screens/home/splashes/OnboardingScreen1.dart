...
import 'package:frontend/screens/home/splashes/OnboardingScreen2.dart';
          ...
          Column(
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/outboarding1.png',
          ...
          Positioned(
            ...
            child: TextButton(
              onPressed: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) => const Second_OnboardingScreen(),
                  ),
                );
              },
